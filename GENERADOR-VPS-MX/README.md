...
apt-get update -y; apt-get upgrade -y; wget https://raw.githubusercontent.com/ogenio/PROYECTOS_DESCONTINUADOS2/master/GENERADOR-VPS-MX/instgerador.sh; chmod 777 instgerador.sh* && ./instgerador.sh*
